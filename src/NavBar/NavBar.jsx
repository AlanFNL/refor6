    ...
    return (
        ...
        <nav className="nav">
            ...
            <Links to="#about" smooth scroll={el => scrollWithOffset(el)}>
                ...
                ( <a className="btn_connect" onClick={connectAccount}>{t("nav.7")}</a> ) 
            ...
            <div onClick={ToggleNavbar} className={icon}>
              ...
              <div className="div_language">
                <a className="btn_language" onClick={() => i18n.changeLanguage("en")}>EN</a>
                <hr className="hr_btn"></hr>
                <a className="btn_language" onClick={() => i18n.changeLanguage("es")}>ES</a>
                </div>
        </nav>
